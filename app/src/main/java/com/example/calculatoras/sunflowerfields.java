...
public class sunflowerfields extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sunflowerfields);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.change_background:
                Intent intent = new Intent(sunflowerfields.this, backgroundselector.class);
