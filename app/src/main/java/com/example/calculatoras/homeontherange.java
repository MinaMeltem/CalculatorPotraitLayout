...
public class homeontherange extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.homeontherange);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.change_background:
                Intent intent = new Intent(homeontherange.this, backgroundselector.class);
